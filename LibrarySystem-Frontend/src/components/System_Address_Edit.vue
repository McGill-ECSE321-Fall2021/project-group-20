<template>
  <div id="address_edit">
    ...
    <div class="msg">
      <h3>Edit your Library's Address here!</h3>
    </div>
    <b-container class="input">
      ...
      <b-row>
        <b-col>
          ...
          <input type="text" v-model="postalCode" id="postal" class="form-control" required>
        </b-col>
        <b-col>
...
<script src="./system_address_edit_script.js">
export default {
