...
export default {
  ...
  methods: {
    create: function (firstname, lastname, email, username, password, password_conf, civic, street, city, postalCode, province, country) {
      if (province.length !== 2) {
       this.error = "Province Invalid: Please enter a two-character province ID (i.e. QC, ON, NB)"
      }
