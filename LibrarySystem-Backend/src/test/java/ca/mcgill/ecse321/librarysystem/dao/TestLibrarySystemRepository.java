...
public class TestLibrarySystemRepository {
	...
	public void testPersistAndLoadLibrarySystemWithCalendar() {
		...
		ls = librarySystemRepository.findLibrarySystemByCalendar(calendarID);
		assertNotNull(ls);
		assertEquals(systemID, ls.getSystemID());
	...
	public void testPersistAndLoadLibrarySystemWithUser() {
		...
		ls = librarySystemRepository.findLibrarySystemByUser(users);
		assertNotNull(ls);
		assertEquals(systemID, ls.getSystemID());
	...
	public void testPersistAndLoadLibrarySystemWithAddress() {
		...
		ls = librarySystemRepository.findLibrarySystemByAddressID(addressID);
		assertNotNull(ls);
		assertEquals(systemID, ls.getSystemID());
	...
	public void testPersistAndLoadLibrarySystemWithItem() {
		...
		ls = librarySystemRepository.findLibrarySystemByItem(items);
		assertNotNull(ls);
		assertEquals(systemID, ls.getSystemID());
